...
maker(
    "Global_Skips",
    baca.metronome_mark("55", selector=baca.selectors.leaf(19)),
    baca.metronome_mark(baca.Accelerando(), selector=baca.selectors.leaf(19)),
    baca.metronome_mark("110", selector=baca.selectors.leaf(23)),
)
