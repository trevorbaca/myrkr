...
maker(
    'GlobalSkips',
    baca.metronome_mark_new(baca.Ritardando()),
    baca.metronome_mark_new('55', selector=baca.leaf(4)),
    baca.metronome_mark_new(baca.Accelerando(), selector=baca.leaf(8)),
    baca.metronome_mark_new('110', selector=baca.leaf(12)),
    )
