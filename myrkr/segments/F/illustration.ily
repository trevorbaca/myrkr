F_GlobalSkips = {                                                              %! extern
    ...
    % [F GlobalSkips measure 161 / measure 1]                                  %! _comment_measure_numbers
...
%@% ^ \baca-dark-cyan-markup [F.1]                                             %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \baca-dark-cyan-markup "[3'49'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% \startTextSpan                                                             %! _attach_metronome_marks(2)
    ...
    % [F GlobalSkips measure 162 / measure 2]                                  %! _comment_measure_numbers
...
%@% ^ \baca-dark-cyan-markup "[3'54'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [F GlobalSkips measure 163 / measure 3]                                  %! _comment_measure_numbers
...
%@% ^ \baca-dark-cyan-markup "[3'58'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time

    % [F GlobalSkips measure 164 / measure 4]                                  %! _comment_measure_numbers
    \time 4/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
...
%@% ^ \baca-dark-cyan-markup "[4'02'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [F GlobalSkips measure 165 / measure 5]                                  %! _comment_measure_numbers
...
%@% ^ \baca-dark-cyan-markup "[4'06'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [F GlobalSkips measure 166 / measure 6]                                  %! _comment_measure_numbers
...
%@% \startTextSpan                                                             %! _attach_metronome_marks(2)
    ...
    % [F GlobalSkips measure 167 / measure 7]                                  %! _comment_measure_numbers
...
%@% ^ \baca-dark-cyan-markup "[4'16'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [F GlobalSkips measure 168 / measure 8]                                  %! _comment_measure_numbers
    \time 4/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
...
%@% ^ \baca-dark-cyan-markup "[4'19'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [F GlobalSkips measure 169 / measure 9]                                  %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
...
%@% ^ \baca-dark-cyan-markup "[4'23'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [F GlobalSkips measure 170 / measure 10]                                 %! _comment_measure_numbers
    \time 3/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                   %! _make_global_skips(1)
...
%@% \startTextSpan                                                             %! _attach_metronome_marks(2)
    ...
    % [F GlobalSkips measure 171 / measure 11]                                 %! _comment_measure_numbers
    \time 2/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/2                                                                   %! _make_global_skips(1)
...
%@% ^ \baca-dark-cyan-markup "[4'32'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [F GlobalSkips measure 172 / measure 12]                                 %! _comment_measure_numbers
    \time 5/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 5/4                                                                   %! _make_global_skips(1)
...
%@% ^ \baca-dark-cyan-markup [F.12]                                            %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \baca-dark-cyan-markup "[4'34'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time

    % [F GlobalSkips measure 173 / measure 13]                                 %! _comment_measure_numbers
    \time 2/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/2                                                                   %! _make_global_skips(1)
...
%@% ^ \baca-dark-cyan-markup "[4'41'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time

    % [F GlobalSkips measure 174 / measure 14]                                 %! _comment_measure_numbers
...
%@% ^ \baca-dark-cyan-markup [F.14]                                            %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \baca-dark-cyan-markup "[4'44'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time

    % [F GlobalSkips measure 175 / measure 15]                                 %! _comment_measure_numbers
    \time 2/4                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/2                                                                   %! _make_global_skips(1)
...
%@% ^ \baca-dark-cyan-markup [F.15]                                            %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \baca-dark-cyan-markup "[4'46'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
...
F_ClarinetMusicVoice = {                                                       %! extern
    ...
    % [F ClarinetMusicVoice measure 161 / measure 1]                           %! _comment_measure_numbers
...
%@% \override ClarinetMusicStaff.Clef.color = ##f                              %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    % [F ClarinetMusicVoice measure 166 / measure 6]                           %! _comment_measure_numbers
    \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue)  %! EXPLICIT_DYNAMIC_COLOR:_attach_color_literal(2)
    a'2
    \ff                                                                        %! EXPLICIT_DYNAMIC:_set_status_tag:IndicatorCommand
    ^ \markup {
    ...
    \times 4/7 {
        ...
        % [F ClarinetMusicVoice measure 167 / measure 7]                       %! _comment_measure_numbers
        \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue) %! EXPLICIT_DYNAMIC_COLOR:_attach_color_literal(2)
        gs'!2
    ...
    % [F ClarinetMusicVoice measure 171 / measure 11]                          %! _comment_measure_numbers
    gs'!2

    % [F ClarinetMusicVoice measure 172 / measure 12]                          %! _comment_measure_numbers
    ...
    % [F ClarinetMusicVoice measure 173 / measure 13]                          %! _comment_measure_numbers
    fs'!2
    ^ \markup {
        \override
            #'(circle-padding . 0.25)
