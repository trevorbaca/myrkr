...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME:baca.SegmentMaker._label_clock_time()
    ...
    % [D Global_Skips measure 142 / measure 32]                                %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(1):PHANTOM
...
D_Global_Rests = {                                                             %! ide.Path.extern()
    ...
    % [D Global_Rests measure 142 / measure 32]                                %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(4):PHANTOM
...
%@% \baca-repeat-pitch-class-coloring                                          %! baca.SegmentMaker._color_repeat_pitch_classes_():REPEAT_PITCH_CLASS_COLORING
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(7):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(4):PHANTOM
            ...
            % [D Clarinet_Music_Voice measure 142 / measure 32]                %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(6):PHANTOM
            ...
            % [D Clarinet_Rest_Voice measure 142 / measure 32]                 %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
