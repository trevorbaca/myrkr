G_GlobalSkips = {
    ...
    % [G GlobalSkips measure 176 / measure 1]                                      %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[4'49'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% \startTextSpan                                                                 %! _attach_metronome_marks(2)
    ...
    % [G GlobalSkips measure 177 / measure 2]                                      %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[4'57'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 178 / measure 3]                                      %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'01'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 179 / measure 4]                                      %! _comment_measure_numbers
...
%@% \startTextSpan                                                                 %! _attach_metronome_marks(2)
    ...
    % [G GlobalSkips measure 180 / measure 5]                                      %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'21'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 181 / measure 6]                                      %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[5'23'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 182 / measure 7]                                      %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[5'24'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 183 / measure 8]                                      %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[5'25'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 184 / measure 9]                                      %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[5'27'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 185 / measure 10]                                     %! _comment_measure_numbers
...
%@% \startTextSpan                                                                 %! _attach_metronome_marks(2)
    ...
    % [G GlobalSkips measure 186 / measure 11]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'29'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 187 / measure 12]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'30'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 188 / measure 13]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'31'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 189 / measure 14]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'31'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 190 / measure 15]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'33'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 191 / measure 16]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'33'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 192 / measure 17]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'34'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 193 / measure 18]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'35'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 194 / measure 19]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'35'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 195 / measure 20]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup "[5'36'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 196 / measure 21]                                     %! _comment_measure_numbers
    \time 1/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[5'37'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 197 / measure 22]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[5'37'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 198 / measure 23]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[5'38'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 199 / measure 24]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[5'38'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    % [G GlobalSkips measure 200 / measure 25]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (200)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.25]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'39'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 201 / measure 26]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (201)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.26]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'39'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 202 / measure 27]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (202)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.27]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'40'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 203 / measure 28]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (203)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.28]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'40'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 204 / measure 29]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (204)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.29]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'41'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 205 / measure 30]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (205)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.30]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'41'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 206 / measure 31]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (206)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.31]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'42'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 207 / measure 32]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (207)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.32]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'43'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 208 / measure 33]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.33]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'43'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 209 / measure 34]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.34]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'44'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 210 / measure 35]                                     %! _comment_measure_numbers
    \time 10/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 5/8                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.35]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'44'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 211 / measure 36]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup [G.36]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'46'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 212 / measure 37]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup [G.37]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'46'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 213 / measure 38]                                     %! _comment_measure_numbers
    \time 3/16                                                                     %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/16                                                                      %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.38]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'47'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 214 / measure 39]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup [G.39]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'48'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 215 / measure 40]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup [G.40]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'48'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 216 / measure 41]                                     %! _comment_measure_numbers
    \time 1/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.41]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'49'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 217 / measure 42]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.42]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'49'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 218 / measure 43]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.43]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'50'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 219 / measure 44]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup [G.44]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'51'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 220 / measure 45]                                     %! _comment_measure_numbers
...
%@% ^ \markup \baca-dark-cyan-markup [G.45]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'52'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 221 / measure 46]                                     %! _comment_measure_numbers
    \time 9/16                                                                     %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 9/16                                                                      %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.46]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'53'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 222 / measure 47]                                     %! _comment_measure_numbers
    \time 5/18                                                                     %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 5/18                                                                      %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.47]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'54'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 223 / measure 48]                                     %! _comment_measure_numbers
    \time 1/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.48]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'54'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 224 / measure 49]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.49]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'55'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 225 / measure 50]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.50]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'56'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 226 / measure 51]                                     %! _comment_measure_numbers
    \time 3/16                                                                     %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/16                                                                      %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.51]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'56'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 227 / measure 52]                                     %! _comment_measure_numbers
    \time 1/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.52]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'56'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 228 / measure 53]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.53]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'57'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 229 / measure 54]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.54]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'58'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [G GlobalSkips measure 230 / measure 55]                                     %! _comment_measure_numbers
    s1 * 1/4                                                                       %! _make_global_skips(1)
...
%@% ^ \markup \baca-dark-cyan-markup [G.55]                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[5'58'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
...
G_ClarinetMusicVoice = {
    ...
    \times 4/5 {
        ...
        % [G ClarinetMusicVoice measure 176 / measure 1]                       %! _comment_measure_numbers
    ...
    \times 2/3 {
        ...
        % [G ClarinetMusicVoice measure 179 / measure 4]                       %! _comment_measure_numbers
        \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue) %! EXPLICIT_DYNAMIC_COLOR:_attach_color_literal(2)
        e\breve
    ...
    % [G ClarinetMusicVoice measure 181 / measure 6]                           %! _comment_measure_numbers
    e'4
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 182 / measure 7]                           %! _comment_measure_numbers
    f'4
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 183 / measure 8]                           %! _comment_measure_numbers
    g'4
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 184 / measure 9]                           %! _comment_measure_numbers
    a'4
    
    % [G ClarinetMusicVoice measure 185 / measure 10]                          %! _comment_measure_numbers
    \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue)  %! EXPLICIT_DYNAMIC_COLOR:_attach_color_literal(2)
    cs''!16
    ...
    \times 8/9 {
        ...
        % [G ClarinetMusicVoice measure 186 / measure 11]                      %! _comment_measure_numbers
        cs''!16
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    \times 8/11 {
        ...
        % [G ClarinetMusicVoice measure 187 / measure 12]                      %! _comment_measure_numbers
        cs''!8
        [
    ...
    \times 8/9 {
        ...
        % [G ClarinetMusicVoice measure 188 / measure 13]                      %! _comment_measure_numbers
        cs''!8
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    \times 2/3 {
        ...
        % [G ClarinetMusicVoice measure 190 / measure 15]                      %! _comment_measure_numbers
        b'8.
        [
    ...
    \times 4/5 {
        ...
        % [G ClarinetMusicVoice measure 192 / measure 17]                      %! _comment_measure_numbers
        b'8
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    \times 2/3 {
        ...
        % [G ClarinetMusicVoice measure 193 / measure 18]                      %! _comment_measure_numbers
        b'8.
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    \times 4/5 {
        ...
        % [G ClarinetMusicVoice measure 194 / measure 19]                      %! _comment_measure_numbers
        b'8.
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    % [G ClarinetMusicVoice measure 196 / measure 21]                          %! _comment_measure_numbers
    \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue)  %! EXPLICIT_DYNAMIC_COLOR:_attach_color_literal(2)
    a'4
    \pppp                                                                      %! EXPLICIT_DYNAMIC:_set_status_tag:IndicatorCommand
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 197 / measure 22]                          %! _comment_measure_numbers
    b'4
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 198 / measure 23]                          %! _comment_measure_numbers
    c''4
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 199 / measure 24]                          %! _comment_measure_numbers
    d''4
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 200 / measure 25]                          %! _comment_measure_numbers
    e''4
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 201 / measure 26]                          %! _comment_measure_numbers
    f''4
    
    % [G ClarinetMusicVoice measure 202 / measure 27]                          %! _comment_measure_numbers
    ...
    \times 8/13 {
        ...
        % [G ClarinetMusicVoice measure 211 / measure 36]                      %! _comment_measure_numbers
        b'8.
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    % [G ClarinetMusicVoice measure 213 / measure 38]                          %! _comment_measure_numbers
    cs''!8
    ^ \markup {
        \override
            #'(circle-padding . 0.25)
    ...
    \times 8/13 {
        ...
        % [G ClarinetMusicVoice measure 214 / measure 39]                      %! _comment_measure_numbers
        \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue) %! EXPLICIT_DYNAMIC_COLOR:_attach_color_literal(2)
        a'16
    ...
    \times 8/9 {
        ...
        % [G ClarinetMusicVoice measure 222 / measure 47]                      %! _comment_measure_numbers
        gs'!8
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    % [G ClarinetMusicVoice measure 227 / measure 52]                          %! _comment_measure_numbers
    \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'DeepPink1) %! REDUNDANT_DYNAMIC_COLOR:_attach_color_literal(2)
    d'4
    \pppp                                                                      %! REDUNDANT_DYNAMIC:_set_status_tag:IndicatorCommand
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 228 / measure 53]                          %! _comment_measure_numbers
    f'4
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 229 / measure 54]                          %! _comment_measure_numbers
    a'4
    \glissando                                                                 %! SC
    
    % [G ClarinetMusicVoice measure 230 / measure 55]                          %! _comment_measure_numbers
    c''4
