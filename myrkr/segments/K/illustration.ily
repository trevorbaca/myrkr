...
%@% \startTextSpan                                                             %! _attach_metronome_marks(2)
    ...
    - \baca_metronome_mark_spanner_colored_left_text 2 0 1 "110" #'green4      %! _attach_metronome_marks(3)
...
%@% ^ \baca-dark-cyan-markup [K.32]                                            %! _label_stage_numbers:STAGE_NUMBER_MARKUP
...
%@% ^ \baca-dark-cyan-markup [K.38]                                            %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \baca-dark-cyan-markup "[9'17'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \baca-dark-cyan-markup [K.43]                                            %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \baca-dark-cyan-markup "[9'22'']"                                        %! CLOCK_TIME_MARKUP:_label_clock_time
    \stopTextSpan                                                              %! _attach_metronome_marks(1)
%@% - \abjad_invisible_line                                                    %! _attach_metronome_marks(2)
%@% - \baca_metronome_mark_spanner_left_text 2 0 1 "55"                        %! _attach_metronome_marks(2)
%@% \startTextSpan                                                             %! _attach_metronome_marks(2)
    - \abjad_invisible_line                                                    %! _attach_metronome_marks(3)
    - \baca_metronome_mark_spanner_colored_left_text 2 0 1 "55" #'blue         %! _attach_metronome_marks(3)
    \startTextSpan                                                             %! _attach_metronome_marks(3)
