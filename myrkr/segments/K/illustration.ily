...
%@% \bacaStartTextSpanMM                                                       %! baca.SegmentMaker._set_status_tag():EXPLICIT_METRONOME_MARK:baca.SegmentMaker._attach_metronome_marks(2)
    ...
    - \tweak bound-details.left.text \markup \concat { \with-color             %! EXPLICIT_METRONOME_MARK_WITH_COLOR:baca.SegmentMaker._attach_metronome_marks(3)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME:baca.SegmentMaker._label_clock_time()
    ...
    % [K Global_Skips measure 356 / measure 46]                                %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(1):PHANTOM
...
K_Global_Rests = {                                                             %! ide.Path.extern()
    ...
    % [K Global_Rests measure 356 / measure 46]                                %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(4):PHANTOM
...
%@% \baca-repeat-pitch-class-coloring                                          %! baca.SegmentMaker._color_repeat_pitch_classes_():REPEAT_PITCH_CLASS_COLORING
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(7):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(4):PHANTOM
            ...
            % [K Clarinet_Music_Voice measure 356 / measure 46]                %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(6):PHANTOM
            ...
            % [K Clarinet_Rest_Voice measure 356 / measure 46]                 %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
