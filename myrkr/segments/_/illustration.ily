...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME:baca.SegmentMaker._label_clock_time()
    ...
    % [_ Global_Skips measure 2]                                               %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(1):PHANTOM
...
i_Global_Rests = {                                                             %! abjad.Path.extern()
    ...
    % [_ Global_Rests measure 2]                                               %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(4):PHANTOM
...
i_Clarinet_Music_Voice = {                                                     %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(7):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(4):PHANTOM
            ...
            % [_ Clarinet_Music_Voice measure 2]                               %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(6):PHANTOM
            ...
            % [_ Clarinet_Rest_Voice measure 2]                                %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
