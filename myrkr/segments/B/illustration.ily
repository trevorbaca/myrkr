B_GlobalSkips = {
    ...
    % [B GlobalSkips measure 57 / measure 1]                                       %! SM_4
...
%@% \startTextSpan                                                                 %! MMI_2
    ...
    % [B GlobalSkips measure 58 / measure 2]                                       %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'04'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 59 / measure 3]                                       %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'05'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 60 / measure 4]                                       %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'06'']"                                    %! SM28:CLOCK_TIME_MARKUP
    
    % [B GlobalSkips measure 61 / measure 5]                                       %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'07'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 62 / measure 6]                                       %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'07'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 63 / measure 7]                                       %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'08'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 64 / measure 8]                                       %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'09'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 65 / measure 9]                                       %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'09'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 66 / measure 10]                                      %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'11'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 67 / measure 11]                                      %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'11'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 68 / measure 12]                                      %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'13'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 69 / measure 13]                                      %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'14'']"                                    %! SM28:CLOCK_TIME_MARKUP
    
    % [B GlobalSkips measure 70 / measure 14]                                      %! SM_4
    \time 2/4                                                                      %! SM8:EXPLICIT_TIME_SIGNATURE:SM_1
    \baca_time_signature_color "blue"                                              %! SM6:EXPLICIT_TIME_SIGNATURE_COLOR:SM_1
    s1 * 1/2                                                                       %! MAKE_GLOBAL_SKIPS_1
...
%@% ^ \markup \baca-dark-cyan-markup "[1'15'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 71 / measure 15]                                      %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'16'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 72 / measure 16]                                      %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'17'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 73 / measure 17]                                      %! SM_4
    \time 4/16                                                                     %! SM8:EXPLICIT_TIME_SIGNATURE:SM_1
    \baca_time_signature_color "blue"                                              %! SM6:EXPLICIT_TIME_SIGNATURE_COLOR:SM_1
    s1 * 1/4                                                                       %! MAKE_GLOBAL_SKIPS_1
...
%@% ^ \markup \baca-dark-cyan-markup "[1'18'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 74 / measure 18]                                      %! SM_4
    \time 2/5                                                                      %! SM8:EXPLICIT_TIME_SIGNATURE:SM_1
    \baca_time_signature_color "blue"                                              %! SM6:EXPLICIT_TIME_SIGNATURE_COLOR:SM_1
    s1 * 2/5                                                                       %! MAKE_GLOBAL_SKIPS_1
...
%@% ^ \markup \baca-dark-cyan-markup "[1'19'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 75 / measure 19]                                      %! SM_4
...
%@% ^ \markup \baca-dark-cyan-markup "[1'19'']"                                    %! SM28:CLOCK_TIME_MARKUP
    ...
    % [B GlobalSkips measure 76 / measure 20]                                      %! SM_4
...
B_ClarinetMusicVoice = {
    ...
    % [B ClarinetMusicVoice measure 57 / measure 1]                            %! SM_4
...
%@% \override ClarinetMusicStaff.Clef.color = ##f                              %! SM7:REAPPLIED_CLEF_COLOR_CANCELLATION:SM37
    ...
    \times 8/11 {
        ...
        % [B ClarinetMusicVoice measure 58 / measure 2]                        %! SM_4
        d''8.
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    % [B ClarinetMusicVoice measure 59 / measure 3]                            %! SM_4
    d''8
    [
    ...
    \times 4/5 {
        ...
        % [B ClarinetMusicVoice measure 60 / measure 4]                        %! SM_4
        d''8.
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    \times 8/11 {
        ...
        % [B ClarinetMusicVoice measure 61 / measure 5]                        %! SM_4
        d''8.
        [
    ...
    \times 4/5 {
        ...
        % [B ClarinetMusicVoice measure 62 / measure 6]                        %! SM_4
        d''8
        [
    ...
    % [B ClarinetMusicVoice measure 63 / measure 7]                            %! SM_4
    d''8.
    ^ \markup {
        \override
            #'(circle-padding . 0.25)
    ...
    \times 8/11 {
        ...
        % [B ClarinetMusicVoice measure 64 / measure 8]                        %! SM_4
        d''16
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    % [B ClarinetMusicVoice measure 65 / measure 9]                            %! SM_4
    \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue)  %! SM6:EXPLICIT_DYNAMIC_COLOR:IC
    cs''!2
    ...
    \times 4/5 {
        ...
        % [B ClarinetMusicVoice measure 66 / measure 10]                       %! SM_4
        cs''!2
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    \times 4/7 {
        ...
        % [B ClarinetMusicVoice measure 67 / measure 11]                       %! SM_4
        cs''!2.
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    % [B ClarinetMusicVoice measure 68 / measure 12]                           %! SM_4
    \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue)  %! SM6:EXPLICIT_DYNAMIC_COLOR:IC
    d''8.
    \p                                                                         %! SM8:EXPLICIT_DYNAMIC:IC
    [
    ...
    \times 4/5 {
        ...
        % [B ClarinetMusicVoice measure 69 / measure 13]                       %! SM_4
        d''8.
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    % [B ClarinetMusicVoice measure 70 / measure 14]                           %! SM_4
    \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue)  %! SM6:EXPLICIT_DYNAMIC_COLOR:IC
    cs''!2
    \mf                                                                        %! SM8:EXPLICIT_DYNAMIC:IC
    ^ \markup {
    ...
    \times 4/5 {
        ...
        % [B ClarinetMusicVoice measure 71 / measure 15]                       %! SM_4
    ...
    \times 8/11 {
        ...
        % [B ClarinetMusicVoice measure 72 / measure 16]                       %! SM_4
        \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue) %! SM6:EXPLICIT_DYNAMIC_COLOR:IC
        d''4
        \p                                                                     %! SM8:EXPLICIT_DYNAMIC:IC
        ^ \markup {
    ...
    \times 4/5 {
        ...
        % [B ClarinetMusicVoice measure 73 / measure 17]                       %! SM_4
        d''8
        ^ \markup {
            \override
                #'(circle-padding . 0.25)
    ...
    \times 4/5 {
        ...
        % [B ClarinetMusicVoice measure 74 / measure 18]                       %! SM_4
        \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'blue) %! SM6:EXPLICIT_DYNAMIC_COLOR:IC
        b'2
        \f                                                                     %! SM8:EXPLICIT_DYNAMIC:IC
    }
    
    % [B ClarinetMusicVoice measure 75 / measure 19]                           %! SM_4
    \once \override ClarinetMusicVoice.DynamicText.color = #(x11-color 'DeepPink1) %! SM6:REDUNDANT_DYNAMIC_COLOR:IC
    bf'!2.
    ...
    \times 4/7 {
        ...
        % [B ClarinetMusicVoice measure 76 / measure 20]                       %! SM_4
        bf'!2
